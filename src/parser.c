...
enum {
  ...
  sym_parameter_type = 18,
  sym_script_block = 19,
  sym_statement = 20,
  sym_if = 21,
  sym_boolean_value = 22,
  aux_sym_param_block_repeat1 = 23,
  aux_sym_script_block_repeat1 = 24,
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [30] = {
    ...
    [anon_sym_DOLLARTRUE] = ACTIONS(134),
    [anon_sym_DOLLARFALSE] = ACTIONS(134),
    [sym_user_variable] = ACTIONS(136),
    [sym_number] = ACTIONS(134),
    [sym_comment] = ACTIONS(32),
  },
  [31] = {
    [sym_user_variable] = ACTIONS(138),
    [sym_comment] = ACTIONS(20),
  },
};
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [96] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(26),
  ...
  [104] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(28),
  [106] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(30),
  [108] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_script, 3),
  [110] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(31),
  [112] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(aux_sym_param_block_repeat1, 2),
  [114] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(aux_sym_param_block_repeat1, 2),
  [116] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_parameter_declaration, 2),
  [118] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_parameter_declaration, 2),
  ...
  [132] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_if, 4),
  [134] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_if, 4),
  [136] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_if, 4),
  [138] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_parameter_type, 3),
};
