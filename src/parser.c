...
enum {
  ...
  sym_if = 27,
  sym_while = 28,
  sym_statement_block = 29,
  sym_boolean_value = 30,
  sym_user_variable = 31,
  aux_sym_param_block_repeat1 = 32,
  aux_sym_parameter_declaration_repeat1 = 33,
  aux_sym_attribute_arguments_repeat1 = 34,
  aux_sym_script_block_repeat1 = 35,
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [39] = {
    [sym_attribute_argument] = STATE(50),
  ...
  [40] = {
    ...
    [aux_sym_SLASH_BSLASH_DOLLAR_LBRACKa_DASHzA_DASHZ_RBRACK_BSLASHw_STAR_SLASH] = ACTIONS(152),
    [sym_comment] = ACTIONS(30),
  },
  [41] = {
  ...
  [43] = {
    ...
    [aux_sym_SLASH_BSLASH_DOLLAR_LBRACKa_DASHzA_DASHZ_RBRACK_BSLASHw_STAR_SLASH] = ACTIONS(162),
    [sym_number] = ACTIONS(160),
    [sym_comment] = ACTIONS(24),
    [sym_signature_block] = ACTIONS(160),
  },
  [44] = {
    [aux_sym_param_block_repeat1] = STATE(44),
  ...
  [45] = {
    ...
    [sym_if] = STATE(55),
    [sym_while] = STATE(55),
    [sym_boolean_value] = STATE(55),
    [sym_user_variable] = STATE(55),
    [aux_sym_script_block_repeat1] = STATE(57),
    [aux_sym_SLASH_LBRACKiI_RBRACK_LBRACKfF_RBRACK_SLASH] = ACTIONS(167),
    [aux_sym_SLASH_LBRACKwW_RBRACK_LBRACKhH_RBRACK_LBRACKiI_RBRACK_LBRACKlL_RBRACK_LBRACKeE_RBRACK_SLASH] = ACTIONS(169),
    [anon_sym_RBRACE] = ACTIONS(171),
    [aux_sym_SLASH_DOLLAR_LPAREN_LBRACKtT_RBRACK_LBRACKrR_RBRACK_LBRACKuU_RBRACK_LBRACKeE_RBRACK_PIPE_LBRACKfF_RBRACK_LBRACKaA_RBRACK_LBRACKlL_RBRACK_LBRACKsS_RBRACK_LBRACKeE_RBRACK_RPAREN_SLASH] = ACTIONS(173),
  ...
  [46] = {
    ...
    [aux_sym_SLASH_LBRACKiI_RBRACK_LBRACKfF_RBRACK_SLASH] = ACTIONS(179),
    [aux_sym_SLASH_LBRACKwW_RBRACK_LBRACKhH_RBRACK_LBRACKiI_RBRACK_LBRACKlL_RBRACK_LBRACKeE_RBRACK_SLASH] = ACTIONS(179),
    [aux_sym_SLASH_DOLLAR_LPAREN_LBRACKtT_RBRACK_LBRACKrR_RBRACK_LBRACKuU_RBRACK_LBRACKeE_RBRACK_PIPE_LBRACKfF_RBRACK_LBRACKaA_RBRACK_LBRACKlL_RBRACK_LBRACKsS_RBRACK_LBRACKeE_RBRACK_RPAREN_SLASH] = ACTIONS(181),
    [aux_sym_SLASH_BSLASH_DOLLAR_LBRACKa_DASHzA_DASHZ_RBRACK_BSLASHw_STAR_SLASH] = ACTIONS(183),
    [sym_number] = ACTIONS(181),
    [sym_comment] = ACTIONS(24),
    [sym_signature_block] = ACTIONS(181),
  },
  [47] = {
  ...
  [50] = {
    [aux_sym_attribute_arguments_repeat1] = STATE(61),
  ...
  [59] = {
    [sym_attribute_argument] = STATE(67),
    [sym_identifier] = ACTIONS(148),
    [sym_comment] = ACTIONS(30),
  },
  [60] = {
  ...
  [61] = {
    [aux_sym_attribute_arguments_repeat1] = STATE(69),
    [anon_sym_COMMA] = ACTIONS(197),
  ...
  [74] = {
    ...
    [sym_boolean_value] = STATE(55),
    [sym_user_variable] = STATE(55),
    [aux_sym_script_block_repeat1] = STATE(78),
    [aux_sym_SLASH_LBRACKiI_RBRACK_LBRACKfF_RBRACK_SLASH] = ACTIONS(167),
    [aux_sym_SLASH_LBRACKwW_RBRACK_LBRACKhH_RBRACK_LBRACKiI_RBRACK_LBRACKlL_RBRACK_LBRACKeE_RBRACK_SLASH] = ACTIONS(169),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [146] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(48),
  [148] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, SHIFT(49),
  [150] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute, 3),
  [152] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_attribute, 3),
  [154] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(51),
  [156] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(aux_sym_param_block_repeat1, 2),
  [158] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_param_block, 5),
  [160] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_param_block, 5),
  [162] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_param_block, 5),
  [164] = {.count = 2, .reusable = true, .depends_on_lookahead = false}, REDUCE(aux_sym_param_block_repeat1, 2), SHIFT_REPEAT(32),
  [167] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(52),
  [169] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(53),
  ...
  [175] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, SHIFT(22),
  [177] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, SHIFT(55),
  [179] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_if, 5),
  [181] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_if, 5),
  [183] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_if, 5),
  [185] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_while, 5),
  [187] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_while, 5),
  [189] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_while, 5),
  [191] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute_arguments, 2),
  [193] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute_argument, 1),
  [195] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(58),
  [197] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(59),
  [199] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(60),
  [201] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute, 4),
  [203] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_attribute, 4),
  [205] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(62),
  [207] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(63),
  [209] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_statement_block, 2),
  [211] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_statement_block, 2),
  [213] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_statement_block, 2),
  [215] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(64),
  [217] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, SHIFT(66),
  [219] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(66),
  [221] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute_arguments, 3),
  [223] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(68),
  [225] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_statement_block, 3),
  [227] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_statement_block, 3),
  [229] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_statement_block, 3),
  [231] = {.count = 2, .reusable = true, .depends_on_lookahead = false}, REDUCE(aux_sym_script_block_repeat1, 2), SHIFT_REPEAT(52),
  ...
  [243] = {.count = 2, .reusable = true, .depends_on_lookahead = true}, REDUCE(aux_sym_script_block_repeat1, 2), SHIFT_REPEAT(55),
  [246] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute_argument, 3),
  [248] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(aux_sym_attribute_arguments_repeat1, 2),
  [250] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_attribute_arguments, 4),
  [252] = {.count = 2, .reusable = true, .depends_on_lookahead = false}, REDUCE(aux_sym_attribute_arguments_repeat1, 2), SHIFT_REPEAT(59),
  [255] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(72),
  [257] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(73),
  [259] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(74),
