...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [104] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, REDUCE(sym_variable, 1),
  [106] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, REDUCE(sym_variable, 1),
  [108] = {.count = 1, .reusable = false, .depends_on_lookahead = false}, REDUCE(sym_variable, 1),
